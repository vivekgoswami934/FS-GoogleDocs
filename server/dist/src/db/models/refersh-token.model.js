...
exports.RefershToken = void 0;
const sequelize_1 = require("sequelize");
const sequelize_typescript_1 = require("sequelize-typescript");
const user_model_1 = require("./user.model");
let RefershToken = (() => {
    let _classDecorators = [(0, sequelize_typescript_1.Table)({ tableName: "refresh_token", underscored: true })];
    ...
    var RefershToken = _classThis = class extends _classSuper {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_classThis, "RefershToken");
    (() => {
        var _a;
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create((_a = _classSuper[Symbol.metadata]) !== null && _a !== void 0 ? _a : null) : void 0;
        _token_decorators = [(0, sequelize_typescript_1.Column)(sequelize_typescript_1.DataType.STRING)];
        _userId_decorators = [(0, sequelize_typescript_1.ForeignKey)(() => user_model_1.User)];
        _user_decorators = [(0, sequelize_typescript_1.BelongsTo)(() => user_model_1.User)];
        ...
        RefershToken = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return RefershToken = _classThis;
})();
exports.RefershToken = RefershToken;
